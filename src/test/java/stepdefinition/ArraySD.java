...
//	@When("The user enter valid python code in tryEditorA from sheet {string} and {int}")
//	public void the_user_enter_valid_python_code_in_try_editor_a_from_sheet_and(String Sheetname, Integer RowNumber) throws Exception {
//		arraypage.validCode(Sheetname, RowNumber);
//	}
//	
//	@When("The user enter python code with invalid syntax in tryEditorA from sheet {string} and {int}")
//	public void the_user_enter_python_code_with_invalid_syntax_in_try_editor_a_from_sheet_and(String Sheetname, Integer RowNumber) throws Exception {
...
//	}
  ...
  public void the_user_enter_valid_python_code_in_try_editor_from_sheet_and_for_the_question(String Sheetname, Integer RowNumber) throws Exception {
     arraypage.TryEditor(Sheetname, RowNumber);
  }
